...
return
{id=41,name="Big Brown Fish",rarity="Common",image="rbxassetid://2539476159",description="A tasty freshly-caught fish that restores 100 HP & MP.",useSound="eat_food",activationEffect=function(_a)
if
