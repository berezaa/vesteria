...
item={id=226,name="Red Apple",rarity="Common",image="rbxassetid://4574376530",description="A crisp apple fresh from the tree.",useSound="eat_food",activationEffect=function(_a)
if
