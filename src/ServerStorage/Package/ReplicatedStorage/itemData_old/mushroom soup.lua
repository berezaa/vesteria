...
return
{id=131,name="Mushroom Soup",rarity="Common",image="rbxassetid://3164341819",description="A hearty bowl of delicious mushroom soup. Fully recovers all HP and MP.",useSound="potion",tier=3,activationEffect=function(_a)
if
