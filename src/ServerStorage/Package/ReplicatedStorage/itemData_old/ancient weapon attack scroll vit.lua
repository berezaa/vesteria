...
return
{id=64,name="Ancient Weapon VIT Scroll (10%)",rarity="Rare",image="rbxassetid://2528903538",description="A very old scroll that will most likely fail. Rumored to have once increased attack power enormously.",tier=4,enchantments={[1]={modifierData={baseDamage=4,vit=3},selectionWeight=5,tier=4},[2]={modifierData={baseDamage=4,vit=3},selectionWeight=2,tier=4},[3]={modifierData={baseDamage=4,vit=3},selectionWeight=1,tier=4}},validation=function(a,b)
if
