...
end},["awaken"]={doNotLoopAnimation=true,doNotStopAnimation=true,lockTimeForPreventStateTransition=2.7,transitionLevel=2,execute=function(caa,daa,_ba,aba)if not aba or
...
caa.manifest.BodyGyro.CFrame=CFrame.new(aba,Vector3.new(cca.X,dba.Y,cca.Z))return"idling"end end
