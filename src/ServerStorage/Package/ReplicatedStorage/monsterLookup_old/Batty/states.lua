...
math.random(1,100)/60;return"sleeping"end},["attack-ready"]={animationEquivalent="idling",transitionLevel=5,step=function(bc,cc)
if
bc.targetEntity==nil or bc.targetEntity==nil then return"idling"end;local dc=bc.manifest.Position;local _d=bc.targetEntity;local ad=_d.Position;local bd=ad
if
