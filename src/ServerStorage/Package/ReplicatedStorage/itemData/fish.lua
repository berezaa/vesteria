...
return
{id=30,name="Fresh Fish",rarity="Common",image="rbxassetid://2528901664",description="A tasty freshly-caught fish that restores 100 HP & MP.",itemType="fish",useSound="eat_food",activationEffect=function(_a)
if
