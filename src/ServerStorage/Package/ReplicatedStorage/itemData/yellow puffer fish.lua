...
return
{id=39,name="Yellow Pufferfish",rarity="Common",image="rbxassetid://2539240983",description="You probably don't want to eat this fish.",itemType="fish",useSound="eat_food",activationEffect=function(_a)
if
