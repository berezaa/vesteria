...
item={id=144,name="Hog Meat",rarity="Common",image="rbxassetid://3164395419",description="Mmm, fresh hog. Restores 70 HP and boosts Attack for 3 minutes.",itemType="food",canStack=true,canBeBound=true,canAwaken=false,sellValue=200,buyValue=2000,activationEffect=function(_a)
if
