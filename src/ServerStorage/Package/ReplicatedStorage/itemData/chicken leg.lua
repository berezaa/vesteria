...
item={id=277,name="Chicken Leg",rarity="Common",image="rbxassetid://5048073993",description="A rare treat.",itemType="food",useSound="eat_food",activationEffect=function(_a)
if
