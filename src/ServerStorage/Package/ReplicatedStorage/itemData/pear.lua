...
item={id=253,name="Pear",rarity="Common",image="rbxassetid://2661683979",description="A ripe pear bustling with flavor.",itemType="food",useSound="eat_food",activationEffect=function(_a)
if
_a.Character then
