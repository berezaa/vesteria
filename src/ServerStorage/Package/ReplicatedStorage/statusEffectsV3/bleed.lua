...
if bb then
local cb={amount=ab*_b,isImmuneToReduction=false}ca.triggerEvent("beforeEntityHealed",bb,cb)bb.Humanoid.Health=
bb.Humanoid.Health+cb.amount
print('heal in tick',_b,cb.amount)ca.triggerEvent("afterEntityHealed",bb,cb)end end;return _a