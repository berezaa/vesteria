local aa={}aa.isActive=false;aa.interactPrompt="WARP"aa.instant=true
...
game.ReplicatedStorage.sounds:FindFirstChild("blink")then
game.ReplicatedStorage.sounds.blink:Play()end
