...
if(not _ba)then
_ba=Instance.new("Folder")_ba.Name=dd;_ba.Archivable=false;_ba.Parent=__a end;local function aba()end
local function bba(bda,cda,dda)
for __b,a_b in pairs(bda:GetChildren())do if
(a_b:IsA(dda)and a_b.Name==cda)then return a_b end end;return nil end
